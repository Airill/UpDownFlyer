...
public class repetableObject : MonoBehaviour
{

    private Transform objectTransform;       //This stores a reference to the collider attached to the Ground.
    ...
    private void Awake()
    {
        ...
        groundHorizontalLength = objectTransform.localScale.x;
    }
    ...
    private void RepositionBackground()
    {
        ...
        Vector3 groundOffSet = new Vector3(44.7f, 0, 0);
